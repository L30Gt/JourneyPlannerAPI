...
namespace Journey.Exception {
    ...
    public class ResourceErrorMessages {
        ...
        /// <summary>
        ///   Looks up a localized string similar to Trip cannot be registered for a past date.
        /// </summary>
        ...
        /// <summary>
        ///   Looks up a localized string similar to Trip end date must be equal to or later than the start date.
        /// </summary>
